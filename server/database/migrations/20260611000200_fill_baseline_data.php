            ...
            [
                ...
                'schema' => [
                    ...
                    'formItems' => [
                        ...
                        $this->switchItem('admin_captcha_switch', '登录安全验证', false, '开启后，登录时需完成人机安全验证'),
                        $this->switchItem('mobile_login_switch', '手机号登录', false, '开启后允许通过手机号验证码登录'),
